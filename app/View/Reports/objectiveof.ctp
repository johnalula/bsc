<h2><?php echo __('Report`s Of '.$officename.' office By Objective'); ?></h2>
...
<table cellpadding="0" cellspacing="0"> 
	<tr>
	    ...
	    <td> <?php echo $this->Form->input('objective_id',array('empty' => 'select a objective')); ?> </td>  </tr>
...
$this->Js->get('#ReportPeriodId')->event('change', 
	$this->Js->request(array(
		...
		'action'=>'getObjectiveReportByOfficeId'
		), array(
		'update'=>'#ReportObjectiveId',
		'async' => true,
		'method' => 'post',
		'dataExpression'=>true,
