<h2><?php echo __('Self Behaveiorevaluation'); ?></h2>
<table cellspacing="0" cellpadding="0" width="100%" border="0" >
  ...
  <?php foreach($behaveiorevaluation as $value):?>
	<tr><td>
		...
		<td>
		<?php if($value['Behaveiorevaluation']['self']==2){
					echo "<span class='icon'>".$this->Html->image('ok.png',array('border'=>'0', 'alt'=>'chose Four'))."</span>";
					}else{
					   echo "<span class='icon'><a href='".$this->Html->url('/behaveiorevaluations/addself/'.
		...
		<td>
		<?php if($value['Behaveiorevaluation']['self']==1){
					echo "<span class='icon'>".$this->Html->image('ok.png',array('border'=>'0', 'alt'=>'chose Four'))."</span>";
					}else{
					   echo "<span class='icon'><a href='".$this->Html->url('/behaveiorevaluations/addself/'.
