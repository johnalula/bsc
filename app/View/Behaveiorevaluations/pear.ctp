<h2><?php echo __('Pear Behaveiorevaluation'); ?></h2>
<table cellspacing="0" cellpadding="0" width="100%" border="0" >
  ...
  <?php foreach($behaveiorevaluation as $value):?>
	<tr>	<td>
		...
		<td>
		<?php if($value['Behaveiorevaluation']['pear']==2){
					echo "<span class='icon'>".$this->Html->image('ok.png',array('border'=>'0', 'alt'=>'chose Four'))."</span>";
					}else{
					   echo "<span class='icon'><a href='".$this->Html->url('/behaveiorevaluations/addpear/'.
		...
		<td>
		<?php if($value['Behaveiorevaluation']['pear']==1){
					echo "<span class='icon'>".$this->Html->image('ok.png',array('border'=>'0', 'alt'=>'chose Four'))."</span>";
					}else{
					   echo "<span class='icon'><a href='".$this->Html->url('/behaveiorevaluations/addpear/'.
