...
class UserAuthComponent extends Component {
	...
	public function getUserId() {
       ...
       public function getUserOfficeId(){
               return $this->Session->read('UserAuth.User.office_id');
        }
       public function getUserOfficeName(){
               return $this->Session->read('UserAuth.Office.office_name');
        }
	public function getUserOfficeReportsTo(){
               return $this->Session->read('UserAuth.Office.office_id');
        }
       public function getUserOfficeNamev($id){
               return $this->Session->read('UserAuth.Office.office_name');
        }
	/**
