...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body>
        <div class="container">
            ...
            <!--/ Codrops top bar -->
            <header>
                <h1>Jimma University BSC <span>Login and Registration Form</span></h1>
            ...
            <section>				
                <div id="container_demo" >
				    ...
				    <?php echo $this->Form->input("email" ,array('label' => false,'div' => false,'placeholder'=>"myusername or mymail@mail.com" ))?>
                                    
                                </p>
                                <p> 
                                    <label for="password" class="youpasswd" data-icon="p"> Your password </label>
				    <?php echo $this->Form->input("password" ,array("type"=>"password",'label' => false,'div' => false,'placeholder'=>"eg. X8df!90EO5" ))?>
