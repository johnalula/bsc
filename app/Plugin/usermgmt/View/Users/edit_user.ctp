		...
		<div class="um_box_mid_content">
			...
			<div class="um_box_mid_content_mid" id="register">
				<div class="um_box_mid_content_mid_left">
					<?php echo $this->Form->create('User',array('url' => array('action' => 'editUser'), 'enctype' => 'multipart/form-data')); ?>
			...
			<?php   }   ?>
					...
					<div>
						<div class="umstyle3"><?php echo __('Picture');?><font color='red'>*</font></div>
						<div class="umstyle4" ><?php echo $this->Form->input("picture" ,array('type'=>'file','label' => false,'div' => false,'class'=>"umstyle5" ))?></div>
						<!--<div style="clear:both"></div>-->
					</div>
					<div>
