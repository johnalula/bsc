	...
	<div class="um_box_mid">
		<div class="um_box_mid_content">
			...
			<?php   if (count($userGroups) >2) { ?>
                                               <div>
							<div class="umstyle3"><?php echo __('Office');?><font color='red'>*</font></div>
  
							<div class="umstyle4" ><?php echo $this->Form->input("office_id" ,array('type' => 'select', 'label' => false,'div' => false,'class'=>"umstyle5" ))?></div>
							<!--<div style="clear:both"></div>-->
						</div>
						<div>
